...
export default function Chat({ roomId, displayName, onLeave, active, onNavigate, onOpenSettings }) {
  ...
  const left = (
    <aside className="w-[280px] xl:w-[320px] bg-white/[0.04] backdrop-blur-2xl border-r border-white/10 flex flex-col flex-shrink-0">
  ...
  return (
    <Shell userName={displayName} active={active} onNavigate={onNavigate} onOpenSettings={onOpenSettings} left={left}>
      {/* Chat tab header */}
      <div className="flex items-center justify-between px-4 sm:px-6 py-3 bg-white/[0.04] backdrop-blur-2xl border-b border-white/10 flex-shrink-0">
        <div className="flex items-center gap-3 min-w-0">
          <div className="relative flex-shrink-0">
            <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#4169E1]/80 to-[#7C3AED]/80 border border-white/20 flex items-center justify-center text-white font-bold text-base shadow-lg shadow-[#4169E1]/30">
              {roomId[0]}
            </div>
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <h2 className="font-mono font-bold text-white text-base tracking-widest truncate">
                {roomId}
              </h2>
              ...
              <span
                className="text-[10px] bg-emerald-500/10 border border-emerald-400/25 text-emerald-300 px-2 py-0.5 rounded-full flex-shrink-0 flex items-center gap-1"
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-red-500/15 border border-red-400/20 text-red-300 hover:bg-red-500/25 text-xs font-semibold px-3 py-2 rounded-lg transition backdrop-blur"
          >
            <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <button
            ...
            className="flex items-center gap-1.5 bg-red-500/20 border border-red-500/30 text-red-400 hover:bg-red-500/30 text-xs font-semibold px-3 py-2 rounded-lg transition backdrop-blur"
