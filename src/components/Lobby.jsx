      ...
      <div className="flex-1 overflow-y-auto p-6 lg:p-10">
        <div className="w-full max-w-3xl mx-auto animate-[fadeUp_.4s_ease]">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#4169E1]/70 to-[#7C3AED]/70 border border-white/20 backdrop-blur-xl flex items-center justify-center shadow-xl shadow-[#4169E1]/30">
          ...
          <div className="mb-6 bg-gradient-to-r from-[#4169E1]/15 to-[#7C3AED]/15 backdrop-blur-2xl border border-white/10 rounded-2xl p-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <button
                onClick={handleGuest}
                className="bg-gradient-to-r from-[#4169E1] to-[#7C3AED] hover:from-[#5e83f5] hover:to-[#4169E1] text-white font-semibold px-5 py-2 rounded-lg text-sm transition shadow-lg shadow-[#4169E1]/30 whitespace-nowrap"
              >
                Use guest account
              </button>
            </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative w-full sm:w-80">
              <input
                ...
                maxLength={20}
                className="w-full bg-white/[0.06] backdrop-blur-xl border border-white/10 rounded-lg px-4 py-2.5 text-sm text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#a78bfa]/60 transition"
              />
              {name.startsWith('Guest-') && (
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {/* Create card */}
            <div className="bg-white/[0.06] backdrop-blur-2xl rounded-2xl border border-white/10 p-6 hover:border-white/25 hover:bg-white/[0.08] transition shadow-xl shadow-black/10">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#4169E1]/60 to-[#7C3AED]/60 border border-white/15 flex items-center justify-center">
            ...
            <div className="bg-white/[0.06] backdrop-blur-2xl rounded-2xl border border-white/10 p-6 hover:border-white/25 hover:bg-white/[0.08] transition shadow-xl shadow-black/10">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#7C3AED]/40 to-[#4169E1]/40 border border-white/15 flex items-center justify-center">
                  <svg className="w-5 h-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
